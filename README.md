...
NOTE: For performance clipping currently uses simple clamping to screen edges.  This can cause edge distortion, but it should be ok for gaming application. Slope correct clipping may be added in the future.
