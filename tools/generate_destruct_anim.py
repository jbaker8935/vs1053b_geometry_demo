...
WORLD_SCALE = 70.0 # scale positions to centimeters


if __name__ == "__main__":
    with open("assets/explosion_export.json", "r") as f:
        anim_data = json.load(f)
    with open("assets/destruct_anim.bin", "wb") as fout:
        ...
        for f_dat in anim_data:
            ...
            for drone in f_dat['drones']:
                # skip ground plane
                if (drone['name'].startswith("Ground")):
                    continue
